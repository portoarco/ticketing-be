...
exports.paymentRejectedMail = void 0;
const paymentRejectedMail = (transactionid, status, amount, quantity, email, first_name, last_name, event_name, start_date, end_date, city, address) => {
    ...
    const statusHTML = status.toUpperCase() === "REJECTED"
...
exports.paymentRejectedMail = paymentRejectedMail;
exports.default = exports.paymentRejectedMail;
