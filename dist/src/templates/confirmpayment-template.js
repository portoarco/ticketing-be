...
exports.paymentConfirmationMail = void 0;
const paymentConfirmationMail = (transactionid, status, amount, quantity, email, first_name, last_name, event_name, start_date, end_date, city, address) => {
    ...
    const statusHTML = status.toUpperCase() === "PAID"
...
exports.paymentConfirmationMail = paymentConfirmationMail;
exports.default = exports.paymentConfirmationMail;
